...
export const ProjectCard = ({ project }: ProjectCardProps) => {
	...
	return (
		<Link
			...
			<article className='group h-[480px] flex flex-col bg-muted/40 hover:bg-pale-sky-300/40 dark:hover:bg-muted/60 backdrop-blur-lg border border-foreground/10 hover:border-accent/70 shadow-[0_16px_40px_-12px_rgba(0,0,0,0.55)] transition-all rounded-lg overflow-hidden'>
				...
				<div className='flex flex-col flex-1 gap-4 p-8'>
					<h2 className='text-lg font-medium transition-all text-foreground/90 group-hover:text-accent'>{project.title}</h2>

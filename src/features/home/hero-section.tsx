...
export const HeroSection = ({ homeInfo }: PageInfoProps) => {
	...
	// JSX Component
	return (
		<section className='relative flex flex-col justify-end w-full h-auto px-4 bg-right-bottom bg-no-repeat bg-cover dark lg:min-h-screen bg-pale-sky-950 bg-hero-image lg:bg-center pt-28'>
			<div
				aria-hidden
			...
			/>
			<div className='relative z-10 container flex justify-between flex-col-reverse lg:flex-row gap-20 lg:gap-16 [text-shadow:0_1px_12px_rgba(0,0,0,0.45)]'>
				<div className='w-full lg:max-w-[550px]'>
					<Image src='/images/logos/logo-dwdevelopment.webp' alt='' width={620} height={83} className='mb-8' />
					...
					<div className='my-12 text-sm text-pale-sky-400 sm:text-base'>
					...
					<div className='flex flex-col items-start gap-3 mt-10 lg:mt-16 md:flex-row md:items-center sm:gap-5'>
